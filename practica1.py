		...
		if verb == "GET":
			if resource == "/":
				...
				httpBody = ("<html><body><form action='/' method='POST' " 
						+ "accept-charset='ISO-8859-1'>Introduce your url:" 
				...
				if urlsh in self.conversions:
					httpCode = "200 OK"
					httpBody = ("<html><body><meta http-equiv='refresh' content='0;" 
							+ " url=" + self.conversions[urlsh] +"' /></body></html>")
				else:
					httpCode = "404 Not Found"
					httpBody = "<html><body><h3>404 Not available resource</h3></body></html>"
